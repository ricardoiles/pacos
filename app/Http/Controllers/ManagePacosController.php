        ...
        if (request()->sonredes == 'sonredes') {
            ...
            if ($facebook=request()->facebook ) {
                ...
                DB::table('redes')->insert(
                    ['Url' => $facebook, 'Tipo' => '1', 'id_restaurante' => $idpacos]
                ); 
                /*//consultar a red insertada antes
                $queryfacebook = DB::table('redes')
                        ->select('id')
                        ->where('Url', $redfacebook)
                        ->latest('Url')
                        ->limit(1)
                        ->get();
            ...
            if ($whastapp=request()->whastapp ) {
                ...
                DB::table('redes')->insert(
                    ['Url' => $whastapp, 'Tipo' => '2', 'id_restaurante' => $idpacos]
                );

                /*//consultar a red insertada antes
                $querywhatsapp = DB::table('redes')
                        ->select('id')
                        ->where('Url', $redwhatsapp)
                        ->latest('Url')
                        ->limit(1)
                        ->get();
            ...
            if ($twitter=request()->twitter ) {
                ...
                DB::table('redes')->insert(
                    ['Url' => $twitter, 'Tipo' => '3', 'id_restaurante' => $idpacos]
                );

                /*//consultar a red insertada antes
                $querytwitter = DB::table('redes')
                        ->select('id')
                        ->where('Url', $redtwitter)
                        ->latest('Url')
                        ->limit(1)
                        ->get();
            ...
            if ($instagram=request()->instagram ) {
                ...
                //RedesPacos::insert($redfacebook);
                DB::table('redes')->insert(
                    ['Url' => $instagram, 'Tipo' => '4', 'id_restaurante' => $idpacos]
                );

                /*//consultar a red insertada antes
                $queryinstagram = DB::table('redes')
                        ->select('id')
                        ->where('Url', $redinstagram)
                        ->latest('Url')
                        ->limit(1)
                        ->get();
            ...
            if ($sitioweb=request()->sitioweb ) {
                ...
                //RedesPacos::insert($redfacebook);
                DB::table('redes')->insert(
                    ['Url' => $sitioweb, 'Tipo' => '5', 'id_restaurante' => $idpacos]
                );

                /*//consultar a red insertada antes
                $querysitioweb = DB::table('redes')
                        ->select('id')
                        ->where('Url', $redsitioweb)
                        ->latest('Url')
                        ->limit(1)
                        ->get();
            ...
            if ($youtube=request()->youtube ) {
                ...
                //RedesPacos::insert($redfacebook);
                DB::table('redes')->insert(
                    ['Url' => $youtube, 'Tipo' => '6', 'id_restaurante' => $idpacos]
                );

                /*//consultar a red insertada antes
                $queryyoutube = DB::table('redes')
                        ->select('id')
                        ->where('Url', $redyoutube)
                        ->latest('Url')
                        ->limit(1)
                        ->get();
